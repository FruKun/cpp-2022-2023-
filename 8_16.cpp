// Написать программу для вычисления производной от функции вида сумма a[i]*exp(-i*x)
...
int main()
{
  ...
  double x = 1;
  cout << "Result: " << obj.derF(x) << endl;      // Result: -1.8188
  cout << "Check:\t" << obj.checkderF(x) << endl; // Check:  -1.8188
}
